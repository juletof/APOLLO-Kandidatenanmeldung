...
namespace ApolloDb
{
    public class PasswortVergessen : IRegisterAsInstancePerLifetime
    {
        ...
        private MailMessage GetMailMessage(string emailAdresse, string passwortResetUrl)
        {
            ...
            mailMessage.Body = @"Falls Sie das Passwort für Ihr Benutzerkonto bei der APOLLO-Online-Bewerbung vergessen haben, folgen Sie bitte diesem Link, um sich ein neues Passwort zu geben: {0}

Der Link ist 72 Stunden lang gültig.
Если вы забыли пароль для входа в систему, перейдите по ссылке и задайте новый пароль:
