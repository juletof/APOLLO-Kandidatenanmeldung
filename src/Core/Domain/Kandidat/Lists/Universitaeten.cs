...
namespace ApolloDb
{
    public class Universitaeten : ListBase
    {
        public Universitaeten()
        {
            ...
            Add(3,"Brjansk --inaktiv--","Брянская государственная сельскохозяйственная академия", istAktiv: false);
            ...
            Add(5, "Ivanovo --inaktiv--", "Ивановская государственная сельскохозяйственная академия имени академика Д.К.Беляева", istAktiv: false);
            ...
            Add(15, "Kaliningrad", "Калининградский филиал Санкт-Петербургского аграрного университета");
            ...
            Add(17, "Tscheljabinsk", "Южно-Уральский государственный аграрный университет (Челябинск)");
        }
